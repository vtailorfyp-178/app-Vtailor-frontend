...
const orders = [
  {
    ...
    tailorSpecialization: 'Formal Dresses, Wedding Attire, Traditional',
    tailorAbout: 'Expert tailor with 8 years of experience in custom tailoring and alterations. Known for quality work and customer satisfaction.',
  ...
  },
  {
    ...
    tailorSpecialization: 'Traditional, Casual',
    tailorAbout: 'Specializes in traditional shalwar kameez and custom casual wear.',
  ...
  },
  {
    ...
    tailorSpecialization: 'Party Wear, Kurtis',
    tailorAbout: 'Contemporary designs for party wear and everyday kurtis.',
  ...
  },
  {
    ...
    tailorEmail: 'zainab@bridaltailors.com',
    tailorAddress: '1 Bridal Lane, Karachi',
    tailorExperience: '10 Years',
    tailorSpecialization: 'Bridal, Lehnga',
    tailorAbout: 'Renowned bridal tailor with premium finishes and embroidery work.',
    tailorDeliveryTime: '14-21 days',
    rating: '4.8 (245 reviews)',
                ...
                router.push({
                  ...
                  params: {
                    ...
                    orderPrice: String(order.price),
                      ...
                      specialization: order.tailorSpecialization,
                      tailorDescription: order.tailorAbout,
