...
const lehngaStyles = [
  ...
  { id: 'lehnga-bridal', name: 'Bridal lehnga', image: bridalImage },
] as const;

export default function LehngaStyleScreen() {
  ...
  return (
    <ThemedView style={styles.container}>
      <View style={[styles.header, { backgroundColor: tint }]}>
        ...
        <ThemedText style={styles.headerTitle}>Lehngay</ThemedText>
        <View style={styles.headerSpacer} />
      </View>

      <ScrollView contentContainerStyle={styles.grid}>
        {lehngaStyles.map((style) => (
          <Pressable
            key={style.id}
            onPress={() =>
              (router as any).push({
