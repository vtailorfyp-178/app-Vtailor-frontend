...
const GLB_WHITE_CIRCULAR_ROUND_BELL = '3d model/3d lehnga/circular/mobile/white round neck bell sleeves circular.glb';
const GLB_WHITE_CIRCULAR_ROUND_FULL = '3d model/3d lehnga/circular/mobile/white round neck full sleeves circular.glb';
const GLB_WHITE_CIRCULAR_V_BELL = '3d model/3d lehnga/circular/mobile/white v neck bell sleeves circular.glb';
const GLB_WHITE_CIRCULAR_V_FULL = '3d model/3d lehnga/circular/mobile/white v neck full sleeves circular.glb';
const GLB_RED_CIRCULAR_ROUND_BELL = '3d model/3d lehnga/circular/mobile/red round neck bell sleeves circular.glb';
const GLB_RED_CIRCULAR_ROUND_FULL = '3d model/3d lehnga/circular/mobile/red round neck full sleeves circular.glb';
const GLB_RED_CIRCULAR_V_BELL = '3d model/3d lehnga/circular/mobile/red v neck bell sleeves circular.glb';
const GLB_RED_CIRCULAR_V_FULL = '3d model/3d lehnga/circular/mobile/red v neck full sleeves circular.glb';
const GLB_BLACK_CIRCULAR_ROUND_BELL = '3d model/3d lehnga/circular/mobile/black round neck bell sleeves circular.glb';
const GLB_BLACK_CIRCULAR_ROUND_FULL = '3d model/3d lehnga/circular/mobile/black round neck full sleeves circular.glb';
const GLB_BLACK_CIRCULAR_V_BELL = '3d model/3d lehnga/circular/mobile/black v neck bell sleeves circular.glb';
const GLB_BLACK_CIRCULAR_V_FULL = '3d model/3d lehnga/circular/mobile/black v neck full sleeves circular.glb';
const GLB_BLUE_CIRCULAR_ROUND_BELL = '3d model/3d lehnga/circular/mobile/blue round neck bell sleeves circular.glb';
const GLB_BLUE_CIRCULAR_ROUND_FULL = '3d model/3d lehnga/circular/mobile/blue round neck full sleeves circular.glb';
const GLB_BLUE_CIRCULAR_V_BELL = '3d model/3d lehnga/circular/mobile/blue v neck bell sleeves circular.glb';
const GLB_BLUE_CIRCULAR_V_FULL = '3d model/3d lehnga/circular/mobile/blue v neck full sleeves circular.glb';
