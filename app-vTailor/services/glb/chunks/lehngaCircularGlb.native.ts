/** Native circular lehnga — Cloudinary `circular/optimized/optimized-*.glb`. */
...
/** Standard filename matches UI neck/sleeves. */
...
/** Blue/black full sleeves: Cloudinary filenames swap round ↔ v-neck (asset labels). */
